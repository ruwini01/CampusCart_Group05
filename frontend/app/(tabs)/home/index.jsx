    ...
    <SafeAreaView className="h-full">
      <View className="w-full h-full px-4">
        ...
        <View className="flex-1 flex-row flex-wrap gap-12 py-10 mb-6 items-center justify-center">
          <IconButton image={icons.sell} title="Buy an Item" handlePress={() => router.push('/(tabs)/home/buyandsellhome')} otherStyle="w-36" />
          ...
          <IconButton image={icons.house} title="Boarding Accommodation" handlePress={() => router.push('/(tabs)/home/bordinghouseshome')} otherStyle="w-36" />
        </View>
      ...
      <View className="justify-center items-center">
        <TouchableOpacity activeOpacity={0.7} onPress={() => router.push('/(tabs)/home/addpost')}>
          <Image source={icons.plus} className="w-14 h-14 mt-[-14]" resizeMode="contain" />
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
