...
const PostDetail = () => {
  ...
  const addBookmark = async () => {
    ...
    try {
      await axios.post(`${apiUrl}/users/addBookmark`, { token, postId: post._id });
      setIsBookmarked(true);
      Alert.alert("Success", "Post has been bookmarked.");
    } catch (error) {
      Alert.alert("Error", "Failed to bookmark the post.");
    }
  };
  ...
  const removeBookmark = async () => {
    ...
    try {
      await axios.post(`${apiUrl}/users/removeBookmark`, { token, postId: post._id });
      setIsBookmarked(false);
      Alert.alert("Success", "Post has been removed from bookmarks.");
    } catch (error) {
      Alert.alert("Error", "Failed to remove the bookmark.");
    }
  };
